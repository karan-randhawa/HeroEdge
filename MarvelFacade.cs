...
namespace HeroEdge
{
    ...
    {
        /*
         * Public Key:  f2394b74cc9cc2140d81d97425d3525a
         * Private Key: 9d48644ec5deb09c500671d9fcfa4733999c2cf3
         */
        private const string PrivateKey = "9d48644ec5deb09c500671d9fcfa4733999c2cf3";
        private const string PublicKey = "f2394b74cc9cc2140d81d97425d3525a";
        ...
        public static async Task PopulateMarvelCharactersAsync(ObservableCollection<Character> marvelCharacters)
        {
            try
            {
                ...
                {
                    // Filter characters that are missing thumbnail 
        ...
        private static async Task<CharacterDataWrapper> GetCharacterDataWrapperAsync()
        {
            ...
            var apiUrl = String.Format("http://gateway.marvel.com:80/v1/public/characters?limit=30&offset={0}", offset);
            var jsonMessage = await CallMarvelAPIAsync(apiUrl);
        ...
        {
            string apiUrl = String.Format("https://gateway.marvel.com:443/v1/public/comics?characters={0}&limit=10", characterId);
            var jsonMessage = await CallMarvelAPIAsync(apiUrl);
        ...
        private static async Task<string> CallMarvelAPIAsync(string apiUrl)
        {
            // Get the MD5 Hash
            var timeStamp = DateTime.Now.Ticks.ToString();
            var hash = CreateHash(timeStamp);

            string completeUrl = String.Format("{0}&apikey={1}&ts={2}&hash={3}", apiUrl, PublicKey, timeStamp, hash);
